...
class AiSettingsController extends Controller
{
    public function update(Request $request): RedirectResponse
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'ai_greeting_message' => ['nullable', 'string', 'max:1000'],
            'ai_custom_instructions' => ['nullable', 'string', 'max:3000'],
            'ai_business_summary' => ['nullable', 'string', 'max:3000'],
            'ai_about_business' => ['nullable', 'string', 'max:3000'],
            'ai_policies' => ['nullable', 'string', 'max:3000'],
            'ai_faq' => ['nullable', 'string', 'max:5000'],
            'ai_recommendations' => ['nullable', 'string', 'max:3000'],
            'ai_avoid' => ['nullable', 'string', 'max:3000'],
        ...
        $salon->update([
            ...
            'ai_greeting_message' => $data['ai_greeting_message'] ?? null,
            'ai_custom_instructions' => $data['ai_custom_instructions'] ?? null,
            'ai_business_summary' => $data['ai_business_summary'] ?? null,
            'ai_about_business' => $data['ai_about_business'] ?? null,
            'ai_policies' => $data['ai_policies'] ?? null,
            'ai_faq' => $data['ai_faq'] ?? null,
            'ai_recommendations' => $data['ai_recommendations'] ?? null,
            'ai_avoid' => $data['ai_avoid'] ?? null,
