...
class SettingsController extends Controller
{
    public function update(Request $request): RedirectResponse
    {
        ...
        $salon->update([
            ...
            'booking_status_email_notifications' => $emailNotificationsAvailable ? $request->boolean('booking_status_email_notifications') : false,
            'email_notifications' => $emailNotificationsAvailable && ($request->boolean('booking_confirmations') || $request->boolean('booking_status_email_notifications')),
